...
Reason kenapa aku guna DHCP (and you are not if setup real server) sebab aku connect dengan internet via mobile hotspot so ip akan sentiasa bertukar (dynamic IP). [[Chapter 1.1 Router Confuguraton]]
